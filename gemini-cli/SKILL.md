---
name: gemini-cli
description: "Use when you need Gemini CLI for current facts, docs lookup, summarization, code review, synthesis, or second-opinion reasoning. Triggers: 'gemini cli', 'ask gemini', 'use gemini', 'run gemini', 'gemini search', 'second opinion', 'parallel research'. Prefer running it in parallel or in a subagent when the work is independent. Requires the gemini CLI on PATH and GEMINI_API_KEY in env."
---
