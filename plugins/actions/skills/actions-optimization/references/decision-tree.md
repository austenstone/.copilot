...
## 0. Ownership and reusable-workflow branch

Before diagnosing a caller, follow every `jobs.<id>.uses` edge transitively. Record the repository, workflow path, ref, runner, permissions, cache setup, and all known callers.
